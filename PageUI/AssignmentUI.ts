export class AssignmentUI {
  ...
  static DATE_PICKER_BUTTON =
    "//button[@id='date' and @data-sentry-source-file='date-picker.tsx']";
  ...
  static TIME_RANGE_DROPDOWN =
    "//button[@data-sentry-source-file='date-range-dropdowns.tsx']";
  static COLUMN_FILTER_BUTTON =
    "//button[@data-sentry-source-file='filter-builder.tsx']";
  static COLUMN_DROPDOWN =
    "//table[@class='table-auto']//button[text()='Column']";
  static ADD_FILTER_BUTTON =
    "//table[@class='table-auto']//following-sibling::button[text()='Add filter']";
  ...
  static LOGICAL_FILRER_OPTIONS =
    "//div[@role='listbox']//div[@role='option']//span[2]";
}
